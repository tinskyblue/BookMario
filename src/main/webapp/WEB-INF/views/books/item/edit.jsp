	...
	<link rel="Stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/css/bootstrap.min.css">
		...
		<div id="root" class="d-flex flex-column min-vh-100">
			...
			<section class="py-5" id="container">
				...
				<div class="container">
					<form name="form" role="edit" action="<c:url value='/books/update/${book.bookID}' />" class="form-horizontal needs-validation" method="post" onsubmit="submitForm(event)" autocomplete="off" novalidate enctype="multipart/form-data">
						<div class="form-group row">
							<div class="col-sm-3">
								...
								<input type="hidden" name="currentFileUrl" value="${books.image}">
								<script>
									$("#img").change(function(){
						...
						<div class="form-group row">
							...
							<div class="col-sm-3">
								<input type="text" name="title" class="form-control" value="${ book.title }" required maxLength=45>
						...
						<div class="form-group row">
							...
							<div class="col-sm-3">
								<input type="text" id="priceInput" name="price" class="form-control" value="${ book.price }" required maxLength="8" oninput="formatPrice(this)">
						...
						<div class="form-group row">
							...
							<div class="col-sm-3">
								<input type="text" name="author" class="form-control" value="${ book.author }" required maxLength=45>
						...
						<div class="form-group row">
							...
							<div class="col-sm-3">
								<input type="text" name="publisher" class="form-control" value="${ book.publisher }" required maxLength=45>
						...
						<div class="form-group row">
							...
							<div class="col-sm-3">
								<input type="text" name="totalPages" class="form-control" value="${ book.totalPages }" required maxLength=8>
						...
						<div class="form-group row">
							...
							<div class="col-sm-3">
								<input type="text" id="bStock" name="stock" class="form-control" value="${ book.stock }" required maxLength=8>
						...
						<div class="form-group row">
							...
							<div class="col-sm-3">
								<textarea cols="50" rows="5" name="content" maxLength=800>${ book.content }"</textarea>
							</div>
						</div>
						<div class="form-group row">
