...
<body>
	<div id="root" class="d-flex flex-column min-vh-100">
		...
		<section class="py-5" id="container">
			...
			<div class="container">
				<form name="form" role="register" action="<c:url value="/books/register" />" class="form-horizontal" method="post" autocomplete="off" novalidate enctype="multipart/form-data">
					...
					<div class="form-group row">
						...
						<div class="col-sm-3">
							<input type="text" name="bookISBN" class="form-control" required maxLength=20>
					...
					<div class="form-group row">
						...
						<div class="col-sm-3">
							<input type="number" name="price" class="form-control" required maxLength=20>
					...
					<div class="form-group row">
						...
						<div class="col-sm-3">
							<input type="text" name="publisher" class="form-control" required maxLength=20>
					...
					<div class="form-group row">
						...
						<div class="col-sm-3">
							<input type="number" name="totalPages" class="form-control" required maxLength=20>
					...
					<div class="form-group row">
						...
						<div class="col-sm-3">
							<input type="number" id="stock" name="stock" class="form-control" required maxLength=20>
