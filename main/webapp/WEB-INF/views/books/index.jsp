			        ...
			        <c:forEach var="book" items="${books}">
			            <div class="col mb-5 conB">
			                <div class="card h-100">
			                    <a href="<c:url value='/books/item/${ book.bookID }'/>"><img src="${ book.image }" class="card-img-top photo" onerror="this.onerror=null; this.src='/resources/img/none.png';" alt="NONE IMG"/></a>
		                  		<div class="card-body">
