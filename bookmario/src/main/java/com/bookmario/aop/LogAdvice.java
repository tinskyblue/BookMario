...
public class LogAdvice {
	...
	@Before("execution(* com.bookmario.service.BookService*.doAdd(String, String)) && args(str1, str2)")
	...
	@AfterThrowing(pointcut = "execution(* com.bookmario.service.BookService*.*(..))", throwing="exception")
	...
	@Around("execution(* com.bookmario.service.BookService*.*(..))")
