...
### 개발기간
**2025/09/27 ~ 2025/10/16**<br>
교습서, 공식 문서, 기술 블로그 등을 참고하여 기능을 먼저 구현하고,<br>
세부적으로 분석하며 **왜 이렇게 구현했는지**, 다른 구현 방법이 있는지, 더 나은 방향은 무엇인지 고민하며 개발했습니다.

**2025/10/16 ~ 기본기 다지기**<br>
현재는 기능 추가없이 유지보수 위주로 업데이트 중입니다.<br>
...
+ JavaScript와 jQuery가 혼용되어 코드 일관성이 부족했고, 실제 결제 PG 시스템을 구현하지 못한 점이 아쉬웠습니다.<br>
  충분히 공부하고 프로젝트를 깊이 이해한 뒤, 코드 통일과 결제 기능 구현을 통해 완성도를 높이고자 합니다.
