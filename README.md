...
모든 학습은 책으로부터 시작한다는 생각에서 비롯되어, 첫 개인 프로젝트는 사용자가 도서를 등록하고 소개할 수 있는 **도서 커뮤니티** 형태로 시작했습니다.<br>
기본 게시판 형태를 구현하고 나니 더 확장하고 싶은 욕심이 생겨, **쇼핑몰 형태로 리팩토링**하여 기능을 확장했습니다.

교습서, 공식 문서, 기술 블로그 등을 참고하여 기능을 먼저 구현하고,<br>
세부적으로 분석하며 **왜 이렇게 구현했는지**, 다른 구현 방법이 있는지, 더 나은 방향은 무엇인지 고민하며 개발하고 있습니다.

### 개발기간
2025/09/27 ~ 2025/10/05
<br>현재도 기능 추가 및 개선을 위해 지속적으로 업데이트 중입니다.
